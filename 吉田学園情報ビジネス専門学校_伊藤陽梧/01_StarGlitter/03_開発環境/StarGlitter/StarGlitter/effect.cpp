...
// マクロ定義
//=============================================================================
#define EFFECTCOUNTERANIM (3)
#define EFFECTPATTERNANIM (3)
#define EFFECTTIMEANIM (10)

#define SUBTRACT_SIZE (D3DXVECTOR3(1.0f, 1.0f, 0.0f))
...
HRESULT CEffect::Load(void)
{
	...
	// テクスチャの読み込み
	HRESULT hr = D3DXCreateTextureFromFile(pDevice, TEXTURE_EFFECT_BULLET, &m_apTexture[EFFECTTYPE_BULLET]);
	hr = D3DXCreateTextureFromFile(pDevice, TEXTURE_EFFECT_CHARGE, &m_apTexture[EFFECTTYPE_CHARGESTATE]);
...
HRESULT CEffect::Init()
{
	...
	case EFFECTTYPE_CHARGESTATE:
		...
		// アニメーションのセット
		SetAnimationSelect(EFFECTCOUNTERANIM, EFFECTPATTERNANIM, 0, EFFECTTIMEANIM);
		break;
