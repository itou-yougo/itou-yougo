...
#define PLAYER_DEFAULT_SIZE (D3DXVECTOR3(25.0f, 80.0f, 25.0f))		// 大きさ
...
#define MOTION_SLASH_FLAME (45.0f)									// 斬るモーションのフレーム
#define MOTION_SLASH_FLAME_COLLISION_START (15.0f)					// 斬るモーションのエフェクトが出るまでのフレーム
