...
#define TEXTURE_HPSPBACK			("data/TEXTURE/hpspback.png")
#define TEXTURE_SP					("data/TEXTURE/sp.png")
#define TEXTURE_SPFLAME				("data/TEXTURE/spflame.png")
#define TEXTURE_ENEMYREMAINDER		("data/TEXTURE/enemyrimainder.png")
#define PLAYER_HP_COLOR				(D3DXCOLOR(0.0f, 1.0f, 0.0f, 1.0f))
#define PLAYER_SP_COLOR				(D3DXCOLOR(1.0f, 0.5f, 0.0f, 1.0f))
