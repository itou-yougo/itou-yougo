...
// タイトルロゴクラスのインスタンス生成
//=============================================================================
CTitleLogo * CTitleLogo::Create(D3DXVECTOR3 pos, float fSizeX, float fSizeY, LOGOTYPE logoType)
{
	// CTitleLogoのポインタ
	...
	{
		// 座標やサイズのセット
		pText->SetText(pos, fSizeX, fSizeY, logoType);
...
void CTitleLogo::Update(void)
{
	...
	case LOGOTYPE_TITLE:
		...
		if (m_bUse == true)
		{
			...
			{
				// プレスエンターの生成
				CTitleLogo::Create(D3DXVECTOR3(SCREEN_CENTER_X, 800.0f, 0.0f), 1220.0f, 166.0f, CTitleLogo::LOGOTYPE_PRESSENTER);
