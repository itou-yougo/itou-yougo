//=============================================================================
//
// おじゃまプレイヤー2の処理 [ojamaplayer2.h]
// Author : 伊藤陽梧
//
//=============================================================================
#ifndef _OJAMAPLAYER2_H_
#define _OJAMAPLAYER2_H_
...
// おじゃまプレイヤー2クラス
//=============================================================================
class COjamaplayer2 :public CScene2D
{
public:
	typedef enum
	{
	...
	static COjamaplayer2 *Create(D3DXVECTOR3 pos, D3DXVECTOR3 move, float fSizeX, float fSizeY, int nCount, D3DXVECTOR3 Accele, OJAMATYPE OjamaType, OBJTYPE objType);
...
private:
	...
	D3DXVECTOR3 m_posPlayer;			  // プレイヤーの座標
	D3DXVECTOR3 m_GetposPlayer;		  // プレイヤーの受け取った座標
