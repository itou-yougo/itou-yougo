...
#define BULLETCOUNTERANIM (2)
#define BULLETPATTERNANIM (1)
#define BULLETTIMEANIM (4)

#define COLOR_MAX (255)

#define EFECT_ADD_SIZE (D3DXVECTOR3(5.0f, 5.0f, 0.0f))
#define EFECT_LIFE (10)
#define EFECT_COLOR (100)
...
HRESULT CBullet::Init()
{
	...
	case BULLET_TYPE_1P:
		...
		{
			// 色のセット
			SetColor(COLOR_MAX, 0, 0, COLOR_MAX);
		}
		// チャージした弾
		if (m_ChargeBulletType == CHARGEBULLET_TYPE_CHARGE)
		{
			// アニメーションのセット
			SetAnimation(BULLETCOUNTERANIM, BULLETPATTERNANIM, BULLETTIMEANIM);
		}
		break;
	...
	case BULLET_TYPE_2P:
		...
		{
			// 色のセット
			SetColor(0, 0, COLOR_MAX, COLOR_MAX);
		}
		// チャージした弾
...
void CBullet::Update(void)
{
	...
	case BULLET_TYPE_1P:
		if (m_ChargeBulletType == CHARGEBULLET_TYPE_NOMAL)
		{
			CEffect::Create(m_pos, m_size + EFECT_ADD_SIZE,
				EFECT_LIFE, COLOR_MAX, EFECT_COLOR, EFECT_COLOR, COLOR_MAX, CEffect::EFFECTTYPE_BULLET, OBJTYPE_EFFECT);
		}
	...
	case BULLET_TYPE_2P:
		...
		{
			CEffect::Create(m_pos, m_size + EFECT_ADD_SIZE,
				EFECT_LIFE, EFECT_COLOR, COLOR_MAX, COLOR_MAX, COLOR_MAX, CEffect::EFFECTTYPE_BULLET, OBJTYPE_EFFECT);
		}
